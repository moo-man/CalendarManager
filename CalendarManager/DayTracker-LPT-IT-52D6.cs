...
namespace CalendarManager
{
    public partial class DayTracker : Form
    {
        ...
        private string parseNoteContent(string stringToParse, out bool general)
        {
            ...
            {
                if (stringToParse.Contains(" years ago)") || stringToParse.Contains(" year ago)") || stringToParse.Contains(" days)") || stringToParse.Contains(" day)")) // If the end parenthesis is not part of the note
