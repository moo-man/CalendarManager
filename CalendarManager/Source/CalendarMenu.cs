...
namespace CalendarManager
{
    public partial class CalendarMenu : Form
    {
        ...
        public CalendarMenu(MainMenu m, Calendar loadedCalendar)
        {
            ...
            /*if (currentCalendar.calendar.calendarName != "" && currentCalendar.calendar.calendarName != null)
            {
                titleText.Text = "The Calendar of " + currentCalendar.calendar.calendarName;

                titleText.Font = new Font(titleText.Font.ToString(), titleText.Font.Size - (currentCalendar.calendar.calendarName.Length*2), FontStyle.Regular);
            }*/
